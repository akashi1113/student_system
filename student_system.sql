/*
 ...
 Source Schema         : student_system_new

 Target Server Type    : MySQL
 Target Server Version : 80018 (8.0.18)
 File Encoding         : 65001

 Date: 07/07/2025 13:33:34
*/
...
CREATE TABLE `comment_like`  (
  ...
  `comment_id` bigint(20) NOT NULL COMMENT '帖子ID',
...
CREATE TABLE `exam_bookings`  (
  ...
  `cancelled_by` bigint(20) NULL DEFAULT NULL COMMENT '取消操作人ID',
...
CREATE TABLE `exam_locations`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '地点ID',
  ...
  `capacity` int(11) NULL DEFAULT 50 COMMENT '容量',
...
CREATE TABLE `exam_notifications`  (
  ...
  `booking_id` bigint(20) NULL DEFAULT NULL COMMENT '预约ID（可为空，系统通知时）',
...
CREATE TABLE `exam_statistics`  (
  ...
  `exam_id` bigint(20) NOT NULL COMMENT '考试ID',
  `total_participants` int(11) NULL DEFAULT 0 COMMENT '总参与人数',
  `completed_count` int(11) NULL DEFAULT 0 COMMENT '完成人数',
  `average_score` decimal(5, 2) NULL DEFAULT 0.00 COMMENT '平均分',
  `max_score` int(11) NULL DEFAULT 0 COMMENT '最高分',
  `min_score` int(11) NULL DEFAULT 0 COMMENT '最低分',
  `pass_rate` decimal(5, 2) NULL DEFAULT 0.00 COMMENT '通过率',
  `average_duration` int(11) NULL DEFAULT 0 COMMENT '平均用时(秒)',
  `violation_count` int(11) NULL DEFAULT 0 COMMENT '总违规次数',
...
CREATE TABLE `exam_time_slots`  (
  ...
  `max_capacity` int(11) NULL DEFAULT 50 COMMENT '最大容量',
  `current_bookings` int(11) NULL DEFAULT 0 COMMENT '当前预约人数',
  ...
  `cancel_deadline_hours` int(11) NULL DEFAULT 24 COMMENT '取消预约截止时间(小时)',
...
CREATE TABLE `experiment_booking`  (
  ...
  `time_slot_id` bigint(20) NULL DEFAULT NULL COMMENT '关联的时间段ID',
  ...
  `approval_status` tinyint(1) NULL DEFAULT 0 COMMENT '审批状态(0-待审批,1-已通过,2-已拒绝)',
  `created_at` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `experiment_report`  (
  ...
  `template_id` bigint(20) NULL DEFAULT NULL COMMENT '报告模板ID',
...
-- ----------------------------
-- Table structure for experiment_template
-- ----------------------------
DROP TABLE IF EXISTS `experiment_template`;
CREATE TABLE `experiment_template`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `experiment_id` bigint(20) NOT NULL COMMENT '关联的实验ID',
  `purpose` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '实验目的',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '实验内容',
  `method` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '实验方法',
  `steps` json NOT NULL COMMENT '实验步骤(JSON格式)',
  `conclusion_guide` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '结论指导',
...
-- ----------------------------
-- Table structure for experiment_time_slot
-- ----------------------------
DROP TABLE IF EXISTS `experiment_time_slot`;
CREATE TABLE `experiment_time_slot`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `experiment_id` bigint(20) NOT NULL COMMENT '关联的实验ID',
  `start_time` datetime NOT NULL COMMENT '时间段开始时间',
  `end_time` datetime NOT NULL COMMENT '时间段结束时间',
  `max_capacity` int(11) NULL DEFAULT 10 COMMENT '最大可预约人数',
  `current_capacity` int(11) NULL DEFAULT 0 COMMENT '当前已预约人数',
...
CREATE TABLE `homework`  (
  ...
  `allow_resubmit` tinyint(4) NULL DEFAULT 0 COMMENT '是否允许重新提交：1-允许，0-不允许',
  `max_submit_times` int(11) NULL DEFAULT 1 COMMENT '最大提交次数',
...
CREATE TABLE `homework_answers`  (
  ...
  `is_correct` tinyint(4) NULL DEFAULT NULL COMMENT '是否正确：1-正确，0-错误，NULL-待批改',
...
CREATE TABLE `homework_submissions`  (
  ...
  `submit_times` int(11) NULL DEFAULT 1 COMMENT '提交次数',
  ...
  `graded_by` bigint(20) NULL DEFAULT NULL COMMENT '批改教师ID',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `homework_id`(`homework_id` ASC) USING BTREE,
...
CREATE TABLE `post_report`  (
  ...
  `post_id` bigint(20) NOT NULL COMMENT '被举报的帖子ID',
  ...
  `status` tinyint(4) NULL DEFAULT 0 COMMENT '处理状态：0-待处理，1-已处理，2-已驳回',
  `handler_id` bigint(20) NULL DEFAULT NULL COMMENT '处理人ID（管理员）',
...
CREATE TABLE `question_banks`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '题库ID',
...
CREATE TABLE `question_options`  (
  ...
  `order_num` int(11) NULL DEFAULT NULL COMMENT '选项序号',
...
CREATE TABLE `questions`  (
  ...
  `score` int(11) NULL DEFAULT 5 COMMENT '题目分数',
  `order_num` int(11) NULL DEFAULT NULL COMMENT '题目序号',
  `analysis` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '题目解析',
  ...
  `time_limit` int(11) NULL DEFAULT NULL COMMENT '单题时间限制(秒)',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_exam_id`(`exam_id` ASC) USING BTREE,
...
CREATE TABLE `student_course`  (
  ...
  `status` tinyint(4) NULL DEFAULT 1 COMMENT '状态：1-正常，0-退课',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `teacher_experiment`  (
  ...
  `subject` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '学科分类',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '实验描述',
  `duration` int(11) NULL DEFAULT 60 COMMENT '预计时长(分钟)',
  `location` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '实验室位置',
  `status` tinyint(4) NULL DEFAULT 1 COMMENT '状态: 0-禁用, 1-可预约, 2-已满额',
  `is_published` tinyint(1) NULL DEFAULT 0 COMMENT '是否发布',
  `steps` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '实验步骤(JSON格式)',
  `created_by` bigint(20) NULL DEFAULT NULL COMMENT '创建教师ID',
  `created_at` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `student_experiment_id` bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_created_by`(`created_by` ASC) USING BTREE,
  INDEX `idx_subject`(`subject` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '教师实验表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_notification`  (
  ...
  `type` tinyint(4) NOT NULL COMMENT '通知类型：1-系统通知 2-帖子通知 3-评论通知',
